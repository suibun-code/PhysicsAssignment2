...
void StartScene::draw()
{
	...
	TheTextureManager::Instance()->draw("wookiee", 50, 250, TheGame::Instance()->getRenderer(), 0, 255, SDL_FLIP_NONE);
...
void StartScene::update()
{
	...
	{
		m_pShip->setPosition(glm::vec2(m_posX, m_posY));
	}
...
void StartScene::start()
{
	...
	TheTextureManager::Instance()->load("../Assets/textures/wookiee.png",
		"wookiee", TheGame::Instance()->getRenderer());
...
void StartScene::m_updateUI()
{
	...
	if (m_displayAbout)
	{
		ImGui::Begin("Physics Assignment 3", &m_displayAbout, ImGuiWindowFlags_AlwaysAutoResize);
		ImGui::Separator();
		ImGui::Text("Authors:");
		ImGui::Text("Ramin Amiri ");
		ImGui::End();
	}
	...
	if (ImGui::Button("Reset All"))
	{
		...
		m_pShip->setPosition(glm::vec2(200.0f, 300.f));
		m_gravity = 9.8f;
		m_PPM = 5.0f;
		m_Atime = 0.016667f;
		m_angle = 45.0f;
	...
	if (ImGui::SliderFloat("Position X", &m_posX, 0.0f, 800.0f, "%.1f"))
	{

	}

	if (ImGui::SliderFloat("Position Y", &m_posY, 0.0f, 800.0f, "%.1f"))
	{
